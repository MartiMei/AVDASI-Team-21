...
def set_servo_angle():
    ...
    if emergency==0:
        ...
        # Calibrated: PWM = 0.0594x^2 - 11.167x + 1380.4
        pwm_elevator = int(0.0594 * angle_elevator**2 - 11.167 * angle_elevator + 1380.4)
        ...
        # Calibrated: PWM = 11.56x + 1568.2
        pwm_rudder = int(11.56 * angle_rudder + 1568.2)
            ...
            if python_control:
                ...
                if emergency==0 and flap_value != 0:
                    if flap_value == 0:
                        ...
                        flap_mode = "TAKEOFF"
                        flap_target_voltage = 1.33
                    elif flap_value == 3:
                        flap_mode = "LANDING"
                        flap_target_voltage = 1.18
                    elif flap_value==4:
