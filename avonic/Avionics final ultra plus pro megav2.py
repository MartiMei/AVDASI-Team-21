    ...
    while not exit_program:
        ...
        if python_control and not safety_enabled:
            master.mav.rc_channels_override_send(
                ...
                int(aileron.get()),
                int(rudder.get()),
                ((1500-int(elevator.get()))+1500)-11, 0, 0, 0#1489
            )
...
elevator = tk.Scale(slider_frame, from_=500, to=2500, orient="vertical", command=update_elevator, length=200, showvalue=False)
elevator.set(1450)
