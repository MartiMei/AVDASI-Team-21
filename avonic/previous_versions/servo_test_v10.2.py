...
def mavlink_thread():
    ...
    while not exit_program: 
        ...
        if msg.get_type() == "RC_CHANNELS":
            ...
            #NEED TO DO CONVERSION BETWEEN PWM AND ANGLE HERE
        ...
        if python_control:
            ...
            master.mav.rc_channels_override_send(
                ...
                int(aileron.get()),
                int(elevator.get()),
                int(aileron.get()),  # throttle channel left untouched
                int(rudder.get()),
...
"""
quit_button = ctk.CTkButton(info_frame, text="Safety switch",command=quit_program,fg_color="red",text_color="black",hover_color="red",width=80)
quit_button.grid(row=1, column=0, padx=10, pady=10,sticky="e")
