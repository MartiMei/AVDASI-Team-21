...
def mavlink_thread():
    global recording, exit_program, python_control, yaw_offset,flap_pwm,flap_ontarget,airspeed,last_flap_mode,last_flap_pwm, sensor_data,flap_switch_value,pot_voltage,servo1_pwm, servo2_pwm, servo4_pwm,armed_state,safety_enabled,override_active
    ...
    while not exit_program: 
        ...
        if msg.get_type() == "RC_CHANNELS":
            ...
            if python_control:
                ...
                if flap_target_voltage ==0: #redundancy code
