...
def set_servo_angle():
    ...
    if emergency==0:
        ...
        pwm_aileron = int(0.0563*(angle_aileron**2)-12.817*(angle_aileron)+1485)
...
def set_custom_flap():
    ...
    try:
        ...
        flap_target_voltage = round(0.0067*entered_flap_angle + 2.4,2)
        cmd_logging(
        "FLAP_MODE_CHANGE",
        mode="CUSTOM",
            ...
            if python_control:
                ...
                if emergency==0:
                    if flap_value == 0:
                        ...
                        #CHANGE THESE VOLTAGE TARGETS, CALIBRATED TO WING
                        flap_mode = "CRUISE"
                        flap_target_voltage = 2.4
                        flap_target_pwm=1400
                    elif flap_value == 2:
                        flap_mode = "TAKEOFF"
                        flap_target_voltage = 2.5
                        flap_target_pwm=1220
                    elif flap_value == 3:
                        flap_mode = "LANDING"
                        flap_target_voltage = 2.6
                        flap_target_pwm=1040
                    elif flap_value==4:
                        ...
                        try:
                            ...
                            pass
                        flap_target_pwm=int(-12.022*(float(entered_flap_angle))+1400)
                        flap_target_voltage = round(0.0067*entered_flap_angle + 2.4,2)
                    ...
                    flap_pwm3 = max(1000, min(2000, flap_target_pwm))
